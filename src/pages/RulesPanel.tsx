                ...
                <>
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-[#1A1F2E] border border-[#2A303C] rounded-xl overflow-hidden z-20 min-w-[280px] shadow-xl">
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-3 text-left text-base font-normal transition-colors ${
                        workspaceId === "all"
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 text-left text-base font-normal text-[#FF6B35] hover:bg-[rgba(255,107,53,0.1)] transition-colors flex items-center gap-2"
                    >
                      <Plus size={16} />
